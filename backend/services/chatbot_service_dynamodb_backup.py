...
from mod    async def get_conversation_history(self, conversation_id: str) -> Optional[ChatConversation]:
    ...
    async def search_policies(self, query: str) -> List[Dict]:
        ...
        return await self._search_policies(query)port ChatMessage, ChatRequest, ChatResponse, ChatConversation
