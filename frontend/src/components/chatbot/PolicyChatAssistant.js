                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {selectedPolicy 
                      ...
                      : "Powered by ChatGPT • Search and explore verified database sources"
                    }
                  </p>
                </div>
              </div>
          ...
          {messages.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                I'm your dedicated policy expert powered by ChatGPT with access to a comprehensive database of verified governance frameworks, 
              ...
              <div className="mt-8 p-4 bg-blue-50/50 backdrop-blur-sm rounded-xl border border-blue-200/50 max-w-2xl mx-auto">
                ...
                <div className="text-xs text-blue-600">
                  All responses are generated by ChatGPT using exclusively our verified AI policy database. 
            ...
            <div className="flex gap-4 justify-start">
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl px-6 py-4 mr-12 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-600">ChatGPT is analyzing policy database...</span>
                </div>
              </div>
            </div>
          )}
