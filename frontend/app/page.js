...
export default function Page() {
  ...
  const renderContent = () => {
    switch (view) {
      case "worldmap":
        return (
          <div className="w-full bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden">
            <WorldMap />
          </div>
        );
      case "globeview":
      ...
      case "submission":
        return (
          <div className="w-full bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-xl">
      ...
      default:
        return (
          <div className={`w-full max-w-7xl mx-auto ${animate ? 'animate-fade-in' : ''}`}>
            {/* Hero Section */}
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center mt-8">
                <div className={`px-6 py-3 rounded-full shadow-lg transition-all ${
                  darkMode 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button
                ...
                className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                <svg className="w-5 h-5 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${darkMode ? 'dark bg-slate-900' : 'bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50'}`}>
      {/* Enhanced Navigation */}
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              {[
                ...
                { key: "globeview", label: "Globe", icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
